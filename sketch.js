var player,playerimage,backgroundimage,bg,crow,crowimage,arrow,arrowimage,score,crowsgroup,arrowsgroup,ArrowSound,fire,fireimage,start,startimage;
...
fire = createSprite(displayWidth-400,displayHeight-350,100,100);

fire.addImage("fireImage",fireimage);

fire.scale=0.5;

start = createSprite(displayWidth/2,displayHeight-400,100,100);
...
function draw (){
    ...
    if (gamestate===("start")){
        ...
        //stroke("grey");
        rect(displayWidth/2,displayHeight-640,500,200);
...
if(keyWentDown("Space")||(touches.fire)){
